# Groww Review Agent — Problem Statement

## Overview

Build an automated **Weekly Review Pulse** system for the **Groww** platform ([Groww on Google Play](https://play.google.com/store/apps/details?id=com.nextbillion.groww&hl=en_IN)).
...
1. **Pull** recent App Store and Play Store reviews for the product (within the rules below).
